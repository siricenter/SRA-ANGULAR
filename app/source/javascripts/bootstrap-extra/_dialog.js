...
(function($) {
    ...
    BootstrapDialog.TYPE_DARK = 'modal-dark';
    ...
    BootstrapDialog.prototype = {
        ...
        getDialogSize: function() {
            return this.options.dialogSize;
        },
        setDialogSize: function(size) {
            this.options.dialogSize = size;
        },
        ...
        realize: function() {
            ...
            this.getModalDialog().addClass(this.getDialogSize());
     ...
     * @returns the created dialog instance
     */
    BootstrapDialog.prompt = function(message, callback) {
        var $input = $('<br><br><input type="text" class="form-control">');
        var $content = $('<div></div>').append(message).append($input);
        return new BootstrapDialog({
            ...
            buttons: [{
                    ...
                    action: function(dialog) {
                        typeof dialog.getData('callback') === 'function' && 
                                dialog.getData('callback')($input.val());
                        dialog.close();
                    }
                }]
        }).open();
